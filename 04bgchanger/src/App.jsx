  ...
  return (
    <>
      <div className='w-full h-screen duration-200 flex flex-col items-center justify-center'
        ...
        {/* Header Section */}
        <header className='fixed top-4 text-center text-white'>
          <h1 className='text-3xl font-bold'>Color Changer App</h1>
          <p className='mt-2'>Click a button to change the background color!</p>
        </header>
        ...
        <div className="fixed flex flex-wrap justify-center bottom-12 inset-x-0 px-2">
          <div className="flex flex-wrap justify-center gap-3 shadow-lg bg-white px-3 py-2 rounded-3xl">
            ...
            <button
              ...
              className='outline-1 px-4 py-2 rounded-full text-black shadow-lg'
